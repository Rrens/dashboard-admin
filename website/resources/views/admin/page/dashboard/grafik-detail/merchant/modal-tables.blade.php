        ...
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <div class="card-body ">
                    <p id="year"></p>
                    <p id="month"></p>
                    <table class="table " id="table_data_merchant_Verify">
                        <thead>
                            <tr>
                                <th>ID Merchant</th>
                                <th>Nama</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <div class="card-body ">
                    <p id="year"></p>
                    <p id="month"></p>
                    <table class="table " id="table_data_merchant_active">
                        <thead>
                            <tr>
                                <th>ID Merchant</th>
                                <th>Nama</th>
...
<div class="modal fade" id="modalMerchantCategory" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center">
            ...
            <div class="modal-body table-responsive">
                <div class="card-body ">
                    <table class="table " id="table_data_rate_merchant_category">
                        <thead>
                            <tr>
                                <th>Transaksi ID</th>
                                <th>User ID</th>
